...
| `HH_EXTRA_ANSWER_PROMPT` | `-answer-prompt` | Дополнительные инструкции для решения тестов.                             |
| `HH_EXTRA_CHAT_PROMPT`   | `-chat-prompt`   | Дополнительные инструкции для ответов в чатах с работодателями.           |
